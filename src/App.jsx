  ...
  return (
    <nav className="original-nav">
      <div className="nav-left">
        <h2 onClick={() => onNavigate('home')} style={{cursor: 'pointer'}}>Samuel Agreda</h2>
        <p>Architect & Developer</p>
      </div>
      <div className="nav-right">
        <div className="nav-links">
          <button className={currentPage === 'home' ? 'active' : ''} onClick={() => onNavigate('home')}>Information</button>
          <span className="separator">/</span>
          <button className={currentPage === 'works' ? 'active' : ''} onClick={() => onNavigate('works')}>Selected Works</button>
        </div>
